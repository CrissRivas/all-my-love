...
export const createArtista = async (req,res) => {
    try {
        const { nombre, imgPerfil, descripcion,estado, redes,imgPortada,imgFondo,comics,tags, seguidores,casa,rango,artRecomendado, comicRecomendado}= req.body
        const newArtista = new Artista({ nombre, imgPerfil, descripcion,estado, redes,imgPortada,imgFondo,comics,tags, seguidores,casa,rango,artRecomendado, comicRecomendado});
